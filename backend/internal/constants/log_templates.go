...
const (
	...
	LogProductUpdateSuccess           = "product update success: product_id=%d title=%s version=%d"
	LogProductUpdateConflict          = "product update conflict: product_id=%d expect_version=%d latest_version=%d"
	...
	LogTradeOrderCreateSuccess        = "trade order create success: order_id=%d product_id=%d frozen_price=%.2f"
