...
const (
	...
	LogProductUpdateSuccess           = "product update success: product_id=%d revision=%d"
	LogProductUpdateConflict          = "product update rejected by optimistic lock: product_id=%d client_revision=%d latest_revision=%d"
